...
export default function Home() {
  ...
  const positionParts = [
    formData.fieldZone.trim(),
    formData.other.trim(),
    formData.puckDistance.trim()
  ].filter(Boolean).join(", ");
